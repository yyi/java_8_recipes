...
public class CompositionDemo {
    ...
    public static void main(String[] args) {
        ...
        Function<Integer, String> plus2toString = ((Function<Integer, Integer>) (x -> x + 2))
                .andThen(Object::toString);
        System.out.println(plus2toString.apply(1).getClass().getName());

        Function<String, Integer> parseThenAdd2 =
                ((Function<Integer, Integer>) CompositionDemo::add2).compose(Integer::parseInt);
